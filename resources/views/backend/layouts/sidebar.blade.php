    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{route('product')}}" class="nav-link">view Product</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{route('featured.products.list')}}" class="nav-link">View</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('general.setting') }}" class="nav-link">General </a></li>
          <li class="nav-item"><a href="table-datatable.html" class="nav-link">Social midea</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
