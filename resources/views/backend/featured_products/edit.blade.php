...
@section('title' , 'Edit Featured-Products')
...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
      ...
      <a class="breadcrumb-item" href="{{route('featured.products.list')}}">Featured Products</a>
      <span class="breadcrumb-item active">Edit Featured Product</span>
    </nav>
